  ...
  machine.preloadImages(images, function() {
    ...
    var banner = machine.createElement({id: "banner", width: width, height: height, backgroundColor: "#fff", overflow: "hidden", cursor: "pointer", boxSizing: "border-box", parent: document.body});
        // create banner elements in here
            // txt assets
            var pack_bg = machine.createElement({id:"pack_bg", backgroundImage: "pack_bg.jpg", left: 367, top: 0, retina: true, parent: banner});
            ...
            // txt num assets
            var txt_num_container = machine.createElement({id:"txt_num_container", left: 17, top: 28, overflow: "hidden", parent: banner});
            ...
            // cta
            var cta = machine.createElement({id:"cta", backgroundImage: "cta.png", left: 665, top: 71, retina: true, parent: banner});
