/* Banner Info
------------------
Mercedes Benz Canada Always On Refresh GLB
Adrian Velazquez
Creative Developer
2025
------------------
  ...
  machine.preloadImages(images, function() {
    ...
    var banner = machine.createElement({id: "banner", width: width, height: height, backgroundColor: "#000", overflow: "hidden", cursor: "pointer", boxSizing: "border-box", parent: document.body});
        // create banner elements in here
            ...
            var cta_box = machine.createElement({id:"cta_box", width: 107, height: 35, left: 715, top: 108, border: "1px solid #ffffff", backgroundColor: "transparent", overflow: "hidden", parent: banner});
    ...
    // set attributes to elements for animation
      TweenMax.set([txt_1, txt_2, txt_3, txt_4, txt_4_1, cta_box], {opacity: 0, y: "+15"});
    ...
    main_tl = new builderTimeLine({onComplete: run_cta})
      ...
      // frame 2
        ...
        .add(txt_in(txt_2))
        .chain(1)
        .add(txt_out(txt_2, move.pan_dist_2))
        .offset(0)
      // frame 3
